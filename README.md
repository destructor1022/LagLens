...
- `LagLens/` — recorder, self-restarting background monitor, continuous UI sentinel, interactive lag marker, and documentation.
...
The generated `LagLens/Reports/` directory, local analysis notes, removal manifests, receipts, and transient request files are excluded from Git. They can contain machine-specific performance and battery telemetry and should remain local.
